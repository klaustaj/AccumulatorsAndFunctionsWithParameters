...
def run_test_better_draw_circles():
    ...
    # Test 1:
    delta_r = 3
    print('Test 1 radius step size:', delta_r)
    better_draw_circles(delta_r)

    # Test 2:
    delta_r = 7
    print('Test 2 radius step size:', delta_r)
    better_draw_circles(delta_r)
...
def run_test_even_better_draw_circles():
    ...
    delta_center_y = 3
    print('Test 1 radius step size:', delta_r)
    print('Test 1 center x-coordinate step size:', delta_center_x)
    print('Test 1 center y-coordinate step size:', delta_center_y)
    even_better_draw_circles(delta_r, delta_center_x, delta_center_y)
    ...
    delta_center_y = -4
    print('Test 2 radius step size:', delta_r)
    print('Test 2 center x-coordinate step size:', delta_center_x)
    print('Test 2 center y-coordinate step size:', delta_center_y)
    even_better_draw_circles(delta_r, delta_center_x, delta_center_y)


def even_better_draw_circles(delta_r, delta_x, delta_y):
    window = rg.RoseWindow(400, 400)

    center = rg.Point(200, 200)
    for k in range(21):
        center = rg.Point(200 + delta_x * k, 200 + delta_y * k)
        circle = rg.Circle(center, delta_r * k)
        circle.attach_to(window)
        window.render(0.05)  # Pauses for 0.05 seconds after rendering.
